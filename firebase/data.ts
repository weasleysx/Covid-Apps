...
export const useTimelineFunctions = () => {
  ...
  const handleAddTimeline = async (gender:string , age:number , career:string ,  selectedDate: string | null,   message: { text: string },setGender: React.Dispatch<React.SetStateAction<string>>,
